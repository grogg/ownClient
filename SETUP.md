...
* If any error on those projects persists, check the project properties. In the 'Android' section, API Level should be
  ...
  - joshuaglenlee-ownclient	-> API level 23 ; in this project, three library projects should appear referred in the bottom of the dialog: 
    - libs\android-support-appcompat-v7-exploded-aar, 
    - libs\android-support-design-exploded-aar, 
    - joshuaglenlee-ownclient-library. 
    - Add them if needed.
...
* cd ../android/joshuaglenlee-ownclient-library
* mvn install
* cd ..
